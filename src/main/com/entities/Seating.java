...
public class Seating implements ISerialisable {
    ...
    public boolean isSeatEmpty(String seat) {
        ...
        if (userRow < 1 || userRow > 8 || userCol < 1 || userCol > 10 || seatMap[userRow - 1][userCol - 1] == 0) {//bad input
...
//            printSeatMap(seatMap);
    ...
    public static void getDisplayString(int[][] seatMap) {//generic print method
        int row, column;
    ...
    public static void seatByCoord(int[][] seatMap) {
        ...
        while (userRow < 1 || userRow > 8 || userCol < 1 || userCol > 10 || seatMap[userRow - 1][userCol - 1] == 1) {//bad input
            System.out.println("Invalid input, try again.");
            System.out.println("\nPlease enter seat coordinates.");
            System.out.print("Row: ");
            userRow = userIn.nextInt();
